...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0  focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-midnight text-beige-100",
        destructive:
          "bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
          "border bg-background shadow-xs hover:bg-green-300 hover:text-beige-100 dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
          "bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80",
        ghost:
          "hover:bg-accent hover:text-beige-200 dark:hover:bg-midnight/50",
        link: "text-primary underline-offset-4 hover:underline",
        custom: 
          "placeholder:text-beige-200 outline-2 outline-green-300 text-beige-100 text-xl leading-14 focus:outline-blue font-bold text-2xl overflow-hidden",
      },
      size: {
        ...
        icon: "size-9",
        custom: "w-72 h-12 px-2.5 rounded-lg",
      },
    },
    defaultVariants: {
      variant: "default",

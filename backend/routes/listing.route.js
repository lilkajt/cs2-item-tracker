...
import { createItem,updateItem, deleteItem, getItems, getItem ,getItemStats, getAllItems } from '../controllers/listing.controller.js';

const router = express.Router();

router.post('/create', verifyUser, createItem);
router.get('', verifyUser, getItems);
router.get('/all', verifyUser, getAllItems);
